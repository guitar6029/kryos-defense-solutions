  ...
  <section class="flex flex-col items-center justify-center gap-2 min-h-screen">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4">
      <div class="flex flex-col gap-2 p-4 border border-r-24">
        <h3 class="text-6xl">Tier-1 Corporate Campus Security</h3>
        <p>
      ...
      <div class="flex flex-col gap-2 p-4 border border-r-24">
        <h3 class="text-6xl">Transit & Subterranean Infrastructure</h3>
        <p>
      ...
      <div class="flex flex-col gap-2 p-4 border border-r-24">
        <h3 class="text-6xl">Energy & Industrial Facilities</h3>
        <p>
      ...
      <div class="flex flex-col gap-2 p-4 border border-r-24">
        <h3 class="text-6xl">Restricted Black-Site Operations</h3>
        <p>
